...
def main():
    ...
    <h2 style="color:white;text-align:center;">Haar Cascade Object Detection</h2>
        ...
        st.write('''
                  ...
                  Linkedin:-https://www.linkedin.com/in/shubham-naik-b9844514a/
    ...
    <h2 style="color:white;text-align:center;">Copyright © 2022 | Shubham Naik </h2>
        ...
        st.markdown(html_temp, unsafe_allow_html=True)
         ...
         html_temp = """
    <body style="background-color:red;">
    <div style="background-image: url('https://i1.wp.com/thedatascientist.com/wp-content/uploads/2015/12/cool_neural_network.jpeg?fit=1500%2C670&ssl=1');
    background-size: cover;padding:150px">
    
    <h2 style="color:white;text-align:center;">FACIAL MOVEMENTS ARE VALUABLE INFORMATION FOR RECOGNIZING EMOTIONS.</h2>
